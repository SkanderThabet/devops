...
public class OperateurControllerTest {
    ...
    Operateur operateur1 = new Operateur(2L,"Thabet","Skander","skander123",null);
    ...
    void addOperateur() {
        ...
        for (Long i=1L;i<=10L;i++) {
            ...
            operateur.setPrenom("Skander");
            operateur.setNom("Thabet");
            operateur.setPassword("skander123");
